    ...
    <div id="popup-container-PG" className="popup-overlay" onClick={onClose}>
      <div className="popup" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="popup-content">
         ...
         <div className="campo" >
            <label>Status 2029-1:</label>
            <br />
            <br />
            <select
              className="campo_input"
              value={gv("status-2029-1")}
         ...
         <div className="campo" >
            <label>Status 2029-2:</label>
            <br />
            <br />
            <select
              className="campo_input"
              value={gv("status-2029-2")}
           ...
           <div className="activity-data" style={{ alignContent:"center"}} >
            ...
            <div className="campo">
                <label>Resultado Indicador 2027-1:</label>
                <br />
                <br />
                <input
                    className="campo_input"
            ...
            <div className="campo">
                <label>Resultado Indicador 2027-2:</label>
                <br />
                <br />
                <input
                    className="campo_input"
           ...
           <div className="activity-data" style={{ alignContent:"center"}} >
            ...
            <div className="campo">
            <label>Resultado Indicador 2028-1:</label>
            <br />
            <br />
            <input
              className="campo_input"
            ...
            <div className="campo">
                <label>Resultado Indicador 2028-2:</label>
                <br />
                <br />
                <input
                    className="campo_input"
            ...
            <div className="campo">
                <label>Resultado Indicador 2029-1:</label>
                <br />
                <br />
                <input
                    className="campo_input"
            ...
            <div className="campo">
                <label>Resultado Indicador 2029-2:</label>
                <br />
                <br />
                <input
                    className="campo_input"
